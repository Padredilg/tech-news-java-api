package com.technews.technewsapi.model;
...
public class User implements Serializable {
    ...
    /*
        FetchType of EAGER means that this list will gather all of its necessary information
        immediately after being created, while the variables designated as LAZY only gather
